...
using UsingRedisInAbp.Tests.CachingSync;

namespace UsingRedisInAbp.Tests
{
    public abstract class UsingRedisInAbpTestBase : AbpIntegratedTestBase
    {
        protected UsingRedisInAbpTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<UsingRedisInAbpApplicationModule>();
            modules.Add<UsingRedisInAbpDataModule>();
        }

        public void UsingDbContext(Action<UsingRedisInAbpDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<UsingRedisInAbpDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<UsingRedisInAbpDbContext, T> func)
        {
            T result;
